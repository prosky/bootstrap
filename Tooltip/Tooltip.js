...
const Tooltip = function (element, options) {
    ...
    // DATA API
    const animationData = element[getAttribute](dataAnimation),
    ...
    const self = this;
    let timer = 0, placementSetting = this[placement];
    let tooltip = null,
    ...
    const removeToolTip = function () {
        ...
        createToolTip = function () {
            ...
            if (titleString && titleString !== "") { // invalidate, maybe markup changed
                ...
                // tooltip arrow
                const tooltipArrow = DOC[createElement](div);
                tooltipArrow[setAttribute](classString, 'arrow');
                tooltip[appendChild](tooltipArrow);

                const tooltipInner = DOC[createElement](div);
