...
const Popover = function (element, options) {
    ...
    // DATA API
    const triggerData = element[getAttribute](dataTrigger), // click / hover / focus
    ...
    // constants, vars
    let popover = null, timer = 0, placementSetting = this[placement];
    const // handlers
        ...
        createPopover = function () {
            ...
            // popover arrow
            const popoverArrow = DOC[createElement](div);
            ...
            if (contentString !== null && self[template] === null) { //create the popover from data attributes
                ...
                if (titleString !== null) {
                    const popoverTitle = DOC[createElement]('h3');
                ...
                const popoverTemplate = DOC[createElement](div);
    ...
    this.hide = function () {
        clearTimeout(timer);
        timer = setTimeout(function () {
            if (popover && hasClass(popover, showClass)) {
