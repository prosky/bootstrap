...
// MODAL DEFINITION
// ===============
const Modal = function (element, options) { // element can be the modal/triggering button
  ...
  var self = this, relatedTarget = null,
      ...
      setScrollbar = function () {
        const bodyStyle = globalObject[getComputedStyle](DOC[body]),
  ...
  this.show = function () {
    ...
    modalTimer = setTimeout(function () {
      ...
      const currentOpen = getElementsByClassName(DOC, component + ' ' + showClass)[0];
